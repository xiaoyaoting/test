...
const DEFAULT_CHAIN_INFO = { type: 'arcblock', id: 'none', host: 'none' };
const errors = {
    pkMissing: {
...
class Authenticator {
    ...
    signJson(data, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                appPk: (0, util_1.toBase58)(wallet.publicKey),
                authInfo: (0, jwt_1.sign)(wallet.address, wallet.secretKey, payload, true, didwallet ? didwallet.jwt : undefined),
            };
        });
    }
    /**
    ...
    signClaims(claims, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const claim = claims.find((x) => x.chainInfo);
            let chainInfo;
            if (claim) {
                const { error, value } = types_1.ChainInfo.validate(claim.chainInfo);
                if (!error) {
                    chainInfo = value;
                }
            }
            if (!chainInfo) {
                chainInfo = yield this.getChainInfo(context);
            }
            const payload = {
                action: 'responseAuth',
                challenge,
            ...
            return {
                appPk: (0, util_1.toBase58)(wallet.publicKey),
                authInfo: (0, jwt_1.sign)(wallet.address, wallet.secretKey, payload, true, didwallet.jwt),
            };
        });
    }
    getWalletInfo(params) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof this.wallet === 'function') {
                // @ts-ignore
                const result = yield this.tryWithTimeout(() => this.wallet(params));
    ...
    getChainInfo(params) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof this.chainInfo === 'function') {
                // @ts-ignore
                const result = yield this.tryWithTimeout(() => this.chainInfo(params));
                const { value, error } = types_1.ChainInfo.validate(result);
                if (error) {
    ...
    verify(data, locale = 'en', enforceTimestamp = true) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userDid = (0, did_1.toAddress)(iss);
                resolve({
                    userDid,
                    userPk: data.userPk,
    ...
    _validateAppInfo(info) {
        ...
        const { value, error } = types_1.AppInfo.validate(info);
        if (error) {
