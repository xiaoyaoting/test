...
export declare type TAnyRequest = TAgreementRequest | TAssetRequest | TAuthPrincipalRequest | TPrepareTxRequest | TProfileRequest | TSignatureRequest | TVerifiableCredentialRequest;
export declare type TAnyResponse = TAgreementResponse | TAssetResponse | TAuthPrincipalResponse | TPrepareTxResponse | TProfileResponse | TSignatureResponse | TVerifiableCredentialResponse;
...
export interface TSignatureRequest {
    ...
    origin?: string;
    type: 'signature';
    typeUrl: 'fg:t:transaction' | 'mime:text/plain' | 'mime:text/html' | 'eth:transaction' | 'eth:standard-data' | 'eth:personal-data' | 'eth:typed-data' | 'eth:legacy-data';
}
