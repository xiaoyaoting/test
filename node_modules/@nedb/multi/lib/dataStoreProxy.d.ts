import { CallbackOptionalError, CallbackWithResult, DataStoreOptions, FilterQuery, IndexOptions, ProjectionQuery, RemoveOptions, Row, AnyObject, UpdateOptions, UpdateQuery, UpdateResult } from '@nedb/core';
import { Cursor } from './cursor';
export declare function createDataStore(socket: any): {
    new <T = AnyObject>(options?: any): {
        ...
        ensureIndex(options: IndexOptions, cb?: CallbackOptionalError): PromiseLike<void>;
        removeIndex(fieldName: string, cb?: CallbackOptionalError): PromiseLike<void>;
